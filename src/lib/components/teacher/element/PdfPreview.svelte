...
<div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
    <div id="pdf-modal" class="bg-white w-[95%] h-[95%] rounded-xl flex flex-col shadow-xl overflow-hidden">
        {#if !isFullscreen}
            <div class="flex items-center justify-between px-5 py-3 border-b bg-gray-50">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button on:click={onClose} class="p-2 rounded hover:bg-red-100 transition">
        ...
        {/if}
        <iframe src={`/teacher/api/pdf/${url.split("/uploads/")[1]}`} class="flex-1 w-full" title="PDF Viewer"/>
    </div>
</div>
{/if}    